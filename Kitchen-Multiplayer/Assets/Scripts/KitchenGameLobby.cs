...
public class KitchenGameLobby : MonoBehaviour
{
    ...
    public event EventHandler<OnLobbyListChangesEventArgs> OnLobbyListChanged;
    public class OnLobbyListChangesEventArgs : EventArgs
    {
    ...
    private async void ListLobbies()
    {
        try
        {
            ...
            OnLobbyListChanged?.Invoke(this, new OnLobbyListChangesEventArgs
            {
